...
print(f'Training accuracy: {round(train_accuracy * 100, 1)}%')
...
print(f'Validation accuracy: {round(val_accuracy * 100, 1)}%')
...
for year, percentage in it_security_jobs_by_year.items():
    print(f"{year}: {round(percentage, 1)}%")
...
print(f"Percentage of jobs classified as IT/information security oriented (2016-2023):")
print(f'{round(it_security_jobs_percentage, 1)}%')